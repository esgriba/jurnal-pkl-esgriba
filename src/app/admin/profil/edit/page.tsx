...
export default function EditPasswordAdminPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const confirmed = await showConfirmation(
      "Konfirmasi Ubah Password Admin",
      "Apakah Anda yakin ingin mengubah password administrator? Pastikan Anda mengingat password baru.",
      "Ya, Ubah",
      "Batal"
    );
    ...
    try {
      ...
      await showSuccess(
        ...
        "Password admin telah berhasil diperbarui. Pastikan untuk menyimpan password baru dengan aman."
      );
    ...
    <DashboardLayout userRole="admin">
      ...
      <div className="mb-6">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Ubah Password Administrator</h1>
            <p className="text-gray-600">Perbarui password akun administrator</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-md p-4">
          <div className="flex items-start">
            ...
            <div className="text-sm">
              <p className="font-medium text-red-800 mb-1">Keamanan Administrator</p>
              <p className="text-red-700">
                Anda sedang mengubah password administrator sistem. 
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-md p-3">
                <div className="flex items-start">
                  ...
                  <div className="text-xs text-amber-800">
                    <p className="font-medium mb-1">Persyaratan Password Admin:</p>
